    ...
    hooks: {
      ...
      frameScreen: function (ctx) {
        ...
        if (typeof state !== 'undefined' && state === STATE_AIM) {
          ...
          // PIN distance + instruction — centered ABOVE the power bar (was top-left at (20,30), which
          // overlapped the hole-start title card). It's about the bar, so it belongs with the bar.
          ctx.fillStyle = 'rgba(255,255,255,0.78)';
          ctx.font = "12px 'Departure Mono', monospace";
          ctx.fillText('PIN ' + pinYds.toLocaleString() + ' YDS · stop the bar in the green for a PERFECT drive', W / 2, by - 26);
