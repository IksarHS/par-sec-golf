...
const FILES = ['game/shared.js', 'game/worlds/run.js', 'game/planet-gen.js', 'game/level-design.js', 'game/modes/desert-golfing.js', 'game/set-pieces.js',
  'game/holegen/spine.js', 'game/holegen/operators.js', 'game/holegen/skin.js', 'game/holegen/caves.js', 'game/holegen/setpieces-dream.js', 'game/holegen/score.js', 'game/holegen/dreamgen.js',
  'game/water.js', 'game/gameplay.js', 'game/runtime/playtest-bot.js'];
