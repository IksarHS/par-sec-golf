...
const SPINE = require('../game/holegen/spine.js'), OPS = require('../game/holegen/operators.js'), SKIN = require('../game/holegen/skin.js');
const CAVES = require('../game/holegen/caves.js'), FLOAT = require('../game/holegen/setpieces-dream.js');
