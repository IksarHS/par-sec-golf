...
const SPINE = require('../src/holegen/spine.js');
const OPS = require('../src/holegen/operators.js');
const SKIN = require('../src/holegen/skin.js');
...
const out = process.argv[2] || '/mnt/c/dev/editor-shots/dreamgen-proto.png';
